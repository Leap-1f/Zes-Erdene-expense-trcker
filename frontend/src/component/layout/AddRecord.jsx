          ...
          <div className="w-[282px] bg-slate-50 flex flex-col mr-20 rounded-lg mt-8">
            ...
            <div>
              ...
              <dialog id="my_modal_1" className="modal">
                <div className="flex flex-col rounded-lg w-[792px] bg-white">
                  <div className="flex rounded-t-lg justify-between  h-[68px] font-semibold text-base items-center bg-white">
                    <h3 className="font-bold text-lg pl-5 ">Add Record</h3>

                    <form method="dialog">
                      {/* if there is a button in form, it will close the modal */}
                      <button className="pr-5">X</button>
                    </form>
                  </div>
                  <div className="flex-col flex w-[792px] h-[412px]">
                    <div className="flex pb-10 bg-white mt-0.5 ml-5">
                      <button className="btn w-[172px] h-[40px] rounded-full text-white bg-blue-600">
                        Expense
                      </button>
                      <button className="btn w-[172px] h-[40px] rounded-full text-black bg-slate-200  ">
                        Income
                      </button>
                    </div>
                    <div className="w-[348px] h-[76px] rounded-lg bg-base-200 flex-col ml-5 flex pl-5 pt-5">
                      <p>Amount</p>
                      <p>₮000.00</p>
                    </div>
                    <div className="w-[348px] h-[48px] rounded-lg bg-base-200 flex-col ml-5 flex pl-5 pt-5 mt-10">
                      <p>Choose</p>
                    </div>
                  </div>
                </div>
              ...
              {/* <div className="flex flex-col">
        <div className="flex justify-between w-[792px] h-[68px]  bg-green-100 font-semibold text-base mt-10 items-center rounded-t-lg">
          
          
        </div>
        <div className="flex-col">
        <div className="flex">
          <button className="btn w-[172px] h-[40px] rounded-full text-white bg-blue-600 flex items-center">
            Expense
          </button>
          <button className="btn w-[172px] h-[40px] rounded-full text-black bg-slate-200 flex items-center">
            Income
          </button>
        </div>
        <div className="w-[348px] h-[76px rounded-lg bg-slate-200">
